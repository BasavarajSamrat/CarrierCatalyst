  ...
  return (
    <div className="add-edit-exam">
      ...
      {(examData || !params.id) && (
        <Form layout="vertical" onFinish={onFinish} initialValues={examData}>
          <Tabs defaultActiveKey="1">
            <TabPane  className="text-white"tab="Exam Details" key="1">
              <Row gutter={[10, 10]}>
                <Col span={8}>
                  <Form.Item label="Exam Name" name="name">
                    <input type="text" />
                ...
                <Col span={8}>
                  <Form.Item label="Category" name="category">
                    <select>
                      <option value="">Select Category</option>
                      <option value="Javascript">Quantitative</option>
                      <option value="React">Verbal</option>
                      <option value="Node">Reasoning</option>
                      <option value="MongoDB">Data intepretation</option>
                      <option value="GK">GK</option>
